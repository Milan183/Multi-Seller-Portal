    ...
    <div style="text-align: center; color: black;">
        ...
        <table class="container" id="table-data" style="text-align: center;">
            ...
            <tr>
                <td> &nbsp; {{$row->id }} &nbsp; </td>
                <td> &nbsp; {{$row->bname }} &nbsp; </td>
                <td><img src="{{asset('upload/brand/images/'.$row->image)}}" alt="{{$row->image}}" width="60px"></td>
                <td> &nbsp; {{$row->seller_id }} &nbsp; </td>
                <td> <a href="/brand/update/{{$row->id}}"> &nbsp; Edit &nbsp; </a> </td>
                <td> <a href="/brand/delete/{{$row->id}}"> &nbsp; Delete &nbsp; </a> </td>
            </tr>
            @endforeach
            <tr>
                @for($i=1;$i<=6;$i++) 
