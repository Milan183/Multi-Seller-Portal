  ...
  <div class="content-wrapper" style="background-color: skyblue;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0" style="color: red;">Add Seller Page</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/seller/view" style="color: blue;">View</a></li>
              <li class="breadcrumb-item active" style="color: black;">Seller</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
                ...
                <form method="POST" enctype="multipart/form-data">
                  @csrf
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <div class="custom-file col-md-1">
                            @if(@$user->id) <img src="{{asset('upload/seller/images/'.@$user->image)}}" width="100px"> @endif
                          </div>
                        </div>
                        @error('image')
                          <div class="validation-error" style="color: red;">{{ $message }}</div>
                      ...
                      <div class="form-group">
                        <center>
                          <input type="submit" class="btn btn-danger" name="submit" value="Add Seller">
                        </center> 
                      </div>
                  </form>
              </section>
