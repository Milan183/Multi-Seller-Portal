  ...
  <div class="content-wrapper" style="background-color: skyblue;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0" style="color: red;">Add Register Page</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/admin/view" style="color: blue;">View</a></li>
              <li class="breadcrumb-item active" style="color: black;">Register</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
                  ...
                  @csrf
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        {{ old('role')=='Admin' ? 'checked' : '' }} {{(@$user->role=='Admin') ? 'checked' : '' }}> Admin
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="radio" id="role" name="role" value="Seller"
                        {{ old('role')=='Seller' ? 'checked' : '' }} {{(@$user->role=='Seller') ? 'checked' : '' }}> Seller
                        @error('role')
                            <div class="validation-error" style="color: red;">{{ $message }}</div>
                        @enderror
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <div class="custom-file col-md-1">
                            @if(@$user->id) <img src="{{asset('upload/register/images/'.@$user->image)}}" width="60px"> @endif
                          </div>
                        </div>
                        @error('image')
                          <div class="validation-error" style="color: red;">{{ $message }}</div>
                      ...
                      <div class="form-group">
                        <center>
                        @if(@$user->id) <input type="submit" class="btn btn-danger" name="submit" value="Update Admin"> 
                        @else <input type="submit" class="btn btn-danger" name="submit" value="Add Admin">
                        @endif
                        </center> 
                      </div>
                  </form>
