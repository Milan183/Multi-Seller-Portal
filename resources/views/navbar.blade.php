  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color: green;">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/dashboard" class="nav-link" style="color: white;">Dashboard</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/register/view" class="nav-link" style="color: white;">Register</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/admin/view" class="nav-link" style="color: white;">Admin</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/seller/view" class="nav-link" style="color: white;">Seller</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/brand/view" class="nav-link" style="color: white;">Brand</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/category/view" class="nav-link" style="color: white;">Category</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/product/view" class="nav-link" style="color: white;">Product</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/login" class="nav-link" style="color: white;">Log In</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
